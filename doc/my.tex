...
\subsection{Phase 1: Arduino IDE config}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \alert{Port}: /dev/tty0 (Linux USB)
        \end{itemize}
...
\subsection{Phase 2: IoT platform (ThingSpeak) - Data channel (public)}
    ...
    \begin{frame}
        \frametitle{Phase 2: IoT platform (ThingSpeak) - Data channel (public)}
...
\subsection{Phase 2: IoT platform (ThingSpeak) - Sending sensor data channel}

    \begin{frame}
        \frametitle{Phase 2: IoT platform (ThingSpeak) - Sending sensor data channel}
...
\subsection{Phase 3: Node-RED as central manager - Deployment}

    \begin{frame}
        \frametitle{Phase 3: Node-RED as central manager - Deployment}
...
\subsection{Phase 3: Node-RED as central manager - Graphical flow}

    \begin{frame}
        \frametitle{Phase 3: Node-RED as central manager - Graphical flow}
